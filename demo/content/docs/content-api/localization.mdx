...
Just like you can create, or update content entries by unique filters, you can either also upsert locales. Simply pass the `locale` you want to update, or create if it does not exist.
...
You can delete all but the default locale using the auto-generated delete mutation.
