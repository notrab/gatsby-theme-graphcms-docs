...
| Field      | Type      | Description                                                                    |
| ---------- | --------- | ------------------------------------------------------------------------------ |
| `url`      | `String!` | The URL of the asset, with any [transformations](/api/assets#transformations). |
...
These fields are localized by default. Learn more about [Localization](/api/localization).
