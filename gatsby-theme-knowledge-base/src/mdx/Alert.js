...
export default function Alert({ type = "default", children }) {
  return (
    <div
      className={cc([
        "border-l-4 my-4 px-4 py-px flex space-x-3",
        {
          "border-primary-400 bg-primary-50 text-primary-400":
            type === "default",
        },
        {
          "border-orange-500 bg-gray-100 text-orange-500": type === "warning",
        },
        {
          "border-red-500 bg-gray-100 text-red-500": type === "danger",
        },
      ])}
    >
      <Icon type={type} />
